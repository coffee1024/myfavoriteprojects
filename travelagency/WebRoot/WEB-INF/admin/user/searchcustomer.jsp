...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">客户检索页面</span></td>
              </tr>
            </table></td>
            <td>
  ...
  <tr>
    ...
    <tr>
    	<form action="<%=path %>/searchcustomer.action" method="post">
        <td colspan="4" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">
      ...
      <s:if test="searchsuggest.size!=0">
						<tr>
						<td colspan="4" height="20" bgcolor="d3eaef" class="STYLE6">
									<div>
									您要查找的是不是：
      ...
      <tr>
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">编号</span></div></td>
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">名称</span></div></td>
       <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">介绍</span></div></td>
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE19">操作</span></div></td>
      </tr>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><a href="<%=path%>/admin/tocustomerinfo?uid=<s:property value='#searchfield.id'/>">查看详情</a></span></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>

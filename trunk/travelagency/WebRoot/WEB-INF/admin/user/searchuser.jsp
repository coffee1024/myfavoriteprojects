...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">员工检索页面</span></td>
              </tr>
            </table></td>
            <td>
  ...
  <tr>
    ...
    <tr>
    	<form action="<%=path %>/searchuser.action" method="post">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><a href="<%=path%>/admin/touserinfo?uid=<s:property value='#searchfield.id'/>">查看详情</a></span></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>

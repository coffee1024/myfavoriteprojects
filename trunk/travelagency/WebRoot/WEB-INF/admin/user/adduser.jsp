...
function checkusername(){
		...
		$.ajax({type: "post",
						url: "<%=path%>/admin/userexist.action", 
...
<form onsubmit="return checkall()" action="<%=path %>/admin/adduser.action" method="post">
<table>
<tr>
<td>用户名</td>
...
<s:iterator value="adminGroup" var="group">
...
<tr>
<td colspan="2" align="left"><input type="submit" value="提交" ></input> </td>
</tr>
</table>
</form>
</body>

 ...
 * @version 1.0
 **/
public class SearchAgency extends BaseAction {
	private Logger logger=LoggerFactory.getLogger(this.getClass());
	private String IDNEX_PATH = ConfigUtil.get("indexdir")+"/travelagency";
	private BooleanClause.Occur[] flags = {BooleanClause.Occur.SHOULD,BooleanClause.Occur.SHOULD,BooleanClause.Occur.SHOULD,BooleanClause.Occur.SHOULD};
	...
	public String execute() {
		...
		try {
			results =BaseSearch.search(IDNEX_PATH,new String[] {searchword,searchword,searchword,searchword}, new String[] {"id","name","address","description"},new String[] {"id","name","address","description"},flags,pageNo,true);
			if (results!=null) {

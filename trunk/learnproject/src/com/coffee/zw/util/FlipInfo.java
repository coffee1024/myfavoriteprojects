...
public class FlipInfo {
	...
	public FlipInfo(int recCount, int pageNo, int pageSize, List elements, String licenseCode) {
		pageStart = pageNo - 5;
	...
	public int getPreviousPageNum() {
		if (isHasPreviousPage()) return pageNo - 1;
		return 1;
	}

	public int getNextPageNum() {
		if (!isHasNextPage()) return pageNo;
		if (pageNo > 1)
			return (pageNo + 1);
		else
			return 2;
